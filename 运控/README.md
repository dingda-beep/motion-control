...
| 15 | [特权学习与鲁棒行走](15-特权学习与鲁棒行走.md) | 特权信息、Oracle 诊断和真机学生之间的边界 |
| 16 | [感知行走与落足点](16-感知行走与落足点.md) | 怎样从看见台阶走到真实踩稳 |
| 17 | [动作重映射与模仿学习](17-动作重映射与模仿学习.md) | 人体动作怎样变成闭环控制，并分清 DeepMimic 逐帧跟踪与 AMP 风格学习 |
...
| 21 | [从零到站立行走的项目路线](21-项目路线.md) | 从传统或 RL 分支走到有契约、证据和恢复路径的真机工程 |
...
| 专题 | 负责解决的断点 | 主线位置 |
|---|---|---|
| [雅可比矩阵从零推导](雅可比矩阵从零推导-二维二关节机械臂.md) | 二关节雅可比怎样从末端位置长出来，为什么转置能把末端力换成关节力矩 | 第 02～03 章 |
| [关节 PD 增益从零推导](关节PD增益从零推导-为什么简单公式能用于RL真机.md) | `K_p/K_d` 为什么能由二阶系统算出，简化设计为什么仍能进入 RL 真机闭环 | 第 04、14 章 |
